  ...
  return (
    <div className=" flex justify-center items-center bg-white rounded-md">
      <form
        ...
        className="sm:w-[450px] w-[360px] relative  shadow-black pt-8 pb-5 sm:px-8 px-4 rounded-lg"
      >
        ...
        <button
          className="bg-red-700 font-semibold text-white w-32  bg-blue-500  py-2  transition-colors  rounded-md my-3"
          type="text"
        >
